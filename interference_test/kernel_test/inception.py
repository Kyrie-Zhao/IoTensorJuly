...
random_data = torch.rand((1, 192, 38, 38)).cuda()
inception = GoogLeNetV3(3).cuda()
#random_data = torch.rand((1, 192, 38, 38)).cpu()
#inception = GoogLeNetV3(3).cpu()
#result = inception(random_data)
#print(np.shape(result))

#stat(inception,(192,38,38))
#sys.exit(1)
...
with torch.autograd.profiler.emit_nvtx():
    ...
    print("Background Inception Done")
