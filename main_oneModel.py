...
def main(mode,name,optimize_type):
    ...
    #_clean _group_4_7_8 _group_6 _group_2_9_9 _group_8 _group_4_14 _group_8_8_8
    graph_name = graph.name+"_clean"
    # optimization mode
    if mode==0:
        if optimize_type == "seq":
            ...
            with open(f"{expr_dir}/{graph_name}.json", "w") as f:
    ...
    # inference mode
        ...
        if optimize_type == "seq":
            with open(f"{expr_dir}/{graph_name}.json","r") as f:
